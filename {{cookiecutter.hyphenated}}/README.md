...
[![Launch on Nextflow Tower](https://img.shields.io/badge/Launch%20%F0%9F%9A%80-Nextflow%20Tower-%234256e7)](https://tower.nf/launch?pipeline=https://github.com/{{cookiecutter.github_username}}/{{cookiecutter.hyphenated}})

## Introduction

<!-- TODO: Write a 1-2 sentence summary of what data the pipeline is for and what it does -->

**{{cookiecutter.github_username}}/{{cookiecutter.hyphenated}}** is {{cookiecutter.description}}.
...
<!-- TODO: Add CONTRIBUTING.MD that is specific to {{cookiecutter.author_name}} -->
